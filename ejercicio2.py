...
print("----------PROGRAMA DE NÓMIMA ÉXITO S.A.S----------")
...
for i in range(num_empleados):
    salario_base = random.uniform(2000, 5000)  # Salario base aleatorio entre 2000 y 5000
    comision = random.uniform(100, 1000)  # Comisión aleatoria entre 100 y 1000
    empleados.append({
        'empleado_id': i + 1,
